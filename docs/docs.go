        ...
        "/users/feed": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by tags (comma separated, e.g. golang,backend)",
                        "name": "tags",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Filter posts after date (YYYY-MM-DD HH:MM:SS)",
                        "name": "since",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter posts before date (YYYY-MM-DD HH:MM:SS)",
                        "name": "until",
                        "in": "query"
                    }
                ],
